                ...
                <div className="pt-4 border-t border-earth-dark/10/50 flex justify-between items-center">
                  ...
                  {job.status === 'pending' ? (
                    <Button 
                      ...
                      className="rounded-xl font-black text-[10px] uppercase tracking-widest px-4 h-9 bg-earth-brown text-earth-primary hover:bg-earth-brown/90 shadow-lg border-none"
                    >
                      Review & Schedule
                    </Button>
                  ) : (
          ...
          <div className={cn("transition-all duration-300", !selectedJob && "opacity-40 blur-[2px] pointer-events-none")}>
            ...
            <div className="space-y-3">
              {availableOperators.map(op => {
                ...
                const activeTractor = op.tractor || { name: 'No Tractor', model: 'N/A' };
