  ...
  return (
    <div className="p-4 md:p-6 space-y-5 md:space-y-6 max-w-7xl mx-auto pb-24 md:pb-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {stats.map((stat, i) => (
          <Card key={i} className="bg-earth-card-alt border-earth-dark/15/50 rounded-[1.2rem]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 md:gap-6">
        ...
        <div className="lg:col-span-8 space-y-5 md:space-y-6">
          {/* Main CTA Card */}
          <Card className="bg-earth-primary text-earth-brown border-none shadow-[0_10px_30px_rgba(234,179,8,0.2)] relative overflow-hidden rounded-[1.5rem]">
            <div className="absolute top-0 right-0 p-4 opacity-10 pointer-events-none transform translate-x-4 -translate-y-4">
              <Tractor size={120} />
            </div>
            <CardContent className="p-5 md:p-8 space-y-4 relative z-10">
              <div className="max-w-md">
                <h2 className="text-2xl md:text-3xl font-black mb-2 tracking-tight">Need a Tractor?</h2>
                <p className="text-earth-brown/80 font-bold text-sm md:text-base leading-relaxed">Book high-quality machinery for your farm in minutes with estimated wait times.</p>
              </div>
              <Link to="/farmer/book" className="inline-block bg-earth-card text-earth-primary hover:bg-earth-card-alt px-6 py-3 text-sm font-black uppercase tracking-wide rounded-xl shadow-[0_4px_15px_rgba(0,0,0,0.2)] transition-transform hover:-translate-y-0.5">
                Book Now <ChevronRight className="inline ml-1" size={16} strokeWidth={3} />
              </Link>
            </CardContent>
          </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-3">
                {isLoading ? (
                  ...
                  <Card className="bg-earth-card-alt/50 border-earth-dark/15/50 border-dashed rounded-xl">
                      <CardContent className="p-4 flex items-center justify-center text-[10px] font-bold text-earth-mut uppercase tracking-widest h-[72px]">
                         No Recent Activity
                      </CardContent>
                  </Card>
                )}
            ...
            <div className="space-y-3">
              ...
              <Card className="bg-earth-card-alt border-earth-dark/15/50 rounded-xl overflow-hidden h-[106px]">
                <CardContent className="p-4 flex flex-col justify-between h-full bg-earth-card">
                  ...
                  <div className="p-2 bg-earth-main/50 border border-earth-dark/15/30 rounded-lg">
            ...
            <Card className="bg-earth-card-alt border-earth-dark/15/50 shadow-sm rounded-xl">
              <CardContent className="p-4 flex items-center gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <p className="font-semibold text-earth-brown text-xs truncate leading-tight">
                    {isLoading ? '...' : dashboardData.location}
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-earth-card-alt border border-earth-primary/10 shadow-sm rounded-xl relative overflow-hidden group">
              ...
              <CardContent className="p-4 flex gap-3 relative z-10">
                ...
                <div className="flex flex-col justify-center">
                  ...
                  <p className="text-[10px] text-earth-sub font-semibold leading-relaxed">Earn ₦500 credits per successful referral.</p>
                </div>
              </CardContent>
            </Card>
          </div>
